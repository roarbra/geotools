...
public class ComplexFeatureIteratorImpl implements FeatureIterator<Feature> {
    ...
    public boolean hasNext() {
        if (!hasNextCalled) {
            try {
                ...
                LOGGER.log(Level.SEVERE, "Parsing complex feature failed.", e);
                return false;
            }
        }
    ...
    public Feature next() throws NoSuchElementException {
        ...
        Feature returnFeature = parsedFeature;
        parsedFeature = null;
        hasNextCalled = false;
    ...
    public void close() {
        try {
            ...
            LOGGER.log(Level.SEVERE, "Closing complex feature iterator failed,", e);
        }
    }
}
