...
public abstract class AbstractComplexBinding implements ComplexBinding {
    ...
    private static final Logger LOGGER = Logging.getLogger(AbstractComplexBinding.class);
    ...
    public void initializeChildContext(
        ...
        if (LOGGER.isLoggable(Level.FINE)) {
            LOGGER.fine(
                    "abstract class AbstractComplexBinding does nothing, "
                            + this.getClass().getName()
                            + " should override initializeChildContext");
        }
    }
